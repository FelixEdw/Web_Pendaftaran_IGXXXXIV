...
<head>
    ...
    <style>
        ...
        :root {
            ...
            /* Cokelat Gelap / Base */
            --color-card-dark: #391E1E;
            /* Dark Reddish Brown untuk Card/Input */
            --color-bronze: #956238;
            /* Bronze Border */
            --color-gold-accent: #FBC02D;
            /* Bright Gold Accent */
            --color-text-light: #FFDA89;
            /* Light Gold/Yellow Text */
            --color-text-white: #FFFFFF;
            --color-text-dark: #14191A;
            --color-button-secondary: #774320;
            /* Warna Cokelat Gelap untuk Link/Tombol Sekunder */
        }
        ...
        .container {
            ...
            /* Menggunakan warna card dark IG */
            margin: 20px;
        ...
        p {
            ...
            font-size: 1rem;
            color: var(--color-text-light);
            /* Mengubah teks sesi aktif menjadi light gold */
            margin-bottom: 2rem;
        }
        ...
        select {
            ...
            /* Sedikit lebih terang dari card dark untuk kontras */
