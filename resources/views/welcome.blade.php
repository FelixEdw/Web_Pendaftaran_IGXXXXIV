...
@section("content")
<section class="py-16 relative min-h-screen bg-cover bg-center font-poppins" style="background-image: url('{{ asset('images/Background_Industrial_Games.png') }}');">
...
<section class="bg-[#14191A] py-40 flex justify-center items-center relative" style="background-image: url('{{ asset('images/Background_Poster.png') }}'); background-size: cover; background-position: center;">
